export const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=${
  ...
  import.meta.env.DEV ? "http://127.0.0.1:5173/oauth/kakao" : import.meta.env.VITE_KAKAO_REDIRECT_URI
}&response_type=code`;
...
export const NAVER_AUTH_URL = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${
  ...
  import.meta.env.DEV ? "http://127.0.0.1:5173/oauth/naver" : import.meta.env.VITE_NAVER_REDIRECT_URI
}`;
